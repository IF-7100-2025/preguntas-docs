...
**Simplicidad**:
-  Evitar elementos innecesarios y priorizar la claridad. 

**Feedback**:
-  Proveer retroalimentación visual y funcional en respuesta a las acciones del usuario.  
...
| Rol        | Hex      | Uso Típico                          |
|------------|----------|-------------------------------------|
| Primario   | #4361ee  | Se utiliza en botones principales y encabezados para resaltar elementos clave visuales. |
| Secundario | #3f37c9  | Se emplea en botones secundarios para diferenciarlos del primario manteniendo coherencia. |
| Acento     | #f72585  | Se aplica en acciones destacadas que requieren atención del usuario. |
| Fondo      | #f5f7ff  | Se usa como fondo general de la aplicación para una apariencia clara y moderna. |
| Texto      | #212529  | Se aplica al contenido principal para asegurar legibilidad y contraste. |
...
|-------------|----------|------------------------------------------------------------------|
| Éxito       | #4cc9f0  | Se utiliza en notificaciones positivas para indicar acciones exitosas. |
| Error       | #ef233c  | Se aplica en mensajes de error o validación para alertar al usuario. |
| Advertencia | #f8961e  | Se emplea en alertas para señalar que se requiere precaución. |
...
### Grid
- 12 columnas para escritorio  
- 4 columnas para móvil  
...
## Conclusión
Seguir esta guía asegura una experiencia de usuario consistente y accesible. Actualiza este documento regularmente para reflejar cambios en los estándares. Para componentes no cubiertos:
